...
type ChartTooltipContentProps = React.HTMLAttributes<HTMLDivElement> & {
  ...
  label?: string | number;
  color?: string;
  formatter?: (value: any, name: string, item?: TooltipItem, index?: number, payload?: any) => React.ReactNode;
...
// Helper
// ------------------------------------------------------------
function getPayloadConfigFromPayload(config: ChartConfig, payload: TooltipItem, key: string) {
